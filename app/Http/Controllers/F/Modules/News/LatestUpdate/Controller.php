...
class Controller extends \App\Http\Controllers\Controller
{
 ...
 public function __construct()
    ...
    $this->table=new \BECM\News\Data\Model ();
 ...
 public function index(){
 	...
 	//;
 	return view('app.F.Modules.News.LatestUpdate.index')->with('data',$data); 	
 }
 public function view($uniqId){
 	...
 	if(!($data==null)){
 	return view('app.F.Modules.News.LatestUpdate.view')->with('data',$data); 	
 	}
 	abort(404);
