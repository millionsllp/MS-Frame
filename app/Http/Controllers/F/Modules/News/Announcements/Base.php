...
public static $base="\FECM\News\Announcements\Base";
public static $controller="\FECM\News\Announcements\Controller";
public static $model="\FECM\News\Announcements\model";
