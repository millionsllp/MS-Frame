...
namespace FECM\AboutUs\Structure;
...
public static $controller="\FECM\AboutUs\Structure\Controller";
public static $model="\FECM\AboutUs\Structure\Model";
...
['name'=>'Desiga','type'=>'string','input'=>'text',],
